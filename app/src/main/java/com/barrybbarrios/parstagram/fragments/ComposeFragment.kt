package com.barrybbarrios.parstagram.fragments
...
import com.barrybbarrios.parstagram.MainActivity
import com.barrybbarrios.parstagram.Post
import com.barrybbarrios.parstagram.R
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                // TODO show a toast to the user to
            }
        }
        ...
        fun submitPost(description: String, user: ParseUser, file: File){
            ...
            post.saveInBackground {
                ...
                if (exception != null){
                    ...
                    // TODO: Show a toast to tell a user something went wrong with saving post
                } else{
